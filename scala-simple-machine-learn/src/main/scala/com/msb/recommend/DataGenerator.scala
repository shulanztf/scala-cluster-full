...
object DataGenerator {
  def main(args: Array[String]) {
    ...
    makelist(10000, "scala-simple-machine-learn/data") // 应用词表,
    makeappdown(10000, "scala-simple-machine-learn/data") // 用户历史下载,主题,是一个应用,游戏中心,是一个应用,应用中心,是一个应用
    makesample(10000, "scala-simple-machine-learn/data") // 模拟正负例样本  = 浏览记录+lable
  }
